  ...
  render() {
    return (
      <table className="ToolTrack">
        <thead>
          <tr>
            {this.props.values.map((v,i) => <th key={i}>{v}</th>)}
          </tr>
        </thead>
        <tbody>
          <tr>
            {this.props.values.map((v,i) =>
              <td key={i}>
                <svg width="30" height="25" viewBox="0 0 100 90" xmlns="http://www.w3.org/2000/svg">
                {i === this.props.track[0] && (
                  <g>
                    <path d="M 3 45 V 65 A 47 20 0 0 0 50 85 A 47 20 0 0 0 97 65 V 45"
                      stroke="#e64505" strokeWidth="3" fill="#fc8d62"
                      />
                ...
                {i === this.props.track[1] && (
                  <g>
                    <path d="M 3 25 V 45 A 47 20 0 0 0 50 65 A 47 20 0 0 0 97 45 V 25"
                      stroke="#c7a200" strokeWidth="3" fill="#ffd92f"
                      />
